...
public class AllocationException extends AbstractThrowableProblem {

    private static final long serialVersionUID = 1L;


    public AllocationException(String defaultMessage) {
        this(ErrorConstants.DEFAULT_TYPE, defaultMessage);
    }

    public AllocationException(URI type, String defaultMessage) {
        super(type, defaultMessage, Status.UNPROCESSABLE_ENTITY, null, null, null, getAlertParameters(defaultMessage, defaultMessage));

    }

    public AllocationException(String defaultMessage, Status status) {
